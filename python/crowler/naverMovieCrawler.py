...
url1 = 'https://movie.naver.com/movie/bi/mi/point.nhn?code='
url2 = '&type=after&isActualPointWriteExcute=false&isMileageSubscriptionAlready=false&isMileageSubscriptionReject=false&page='

hdr = {
    'User-Agent' : 'Mozilla/5.0 (Windows NT 6.4; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/46.0.2490.86 Safari/537.36',
